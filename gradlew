...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    case $i in
        ...
        1) set -- "$set_1" ;;
        2) set -- "$set_1" "$set_2" ;;
        3) set -- "$set_1" "$set_2" "$set_3" ;;
        4) set -- "$set_1" "$set_2" "$set_3" "$set_4" ;;
        5) set -- "$set_1" "$set_2" "$set_3" "$set_4" "$set_5" ;;
        6) set -- "$set_1" "$set_2" "$set_3" "$set_4" "$set_5" "$set_6" ;;
        7) set -- "$set_1" "$set_2" "$set_3" "$set_4" "$set_5" "$set_6" "$set_7" ;;
        8) set -- "$set_1" "$set_2" "$set_3" "$set_4" "$set_5" "$set_6" "$set_7" "$set_8" ;;
        9) set -- "$set_1" "$set_2" "$set_3" "$set_4" "$set_5" "$set_6" "$set_7" "$set_8" "$set_9" ;;
    esac
fi
